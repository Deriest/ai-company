...
- Name: backend-integration.spec.ts >> Backend API Integration >> conversation list endpoint is accessible via /api/conversations
- Location: e2e/backend-integration.spec.ts:22:7
...
Call log:
  - → GET http://127.0.0.1:5174/api/conversations
