...
- Name: backend-integration.spec.ts >> Backend API Integration >> verify route endpoints respond to health check
- Location: e2e/backend-integration.spec.ts:58:7
...
Call log:
  - → GET http://127.0.0.1:5174/planning/health
