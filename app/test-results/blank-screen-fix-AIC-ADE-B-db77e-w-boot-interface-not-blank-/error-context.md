...
- Name: blank-screen-fix.spec.ts >> AIC-ADE Blank Screen Fix v2.6.11 >> should show boot interface (not blank)
- Location: e2e/blank-screen-fix.spec.ts:9:7
...
```yaml
- generic [active] [ref=e1]: "{\"detail\":\"Not Found\"}"
```
